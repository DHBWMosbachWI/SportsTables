...
for year in years:
    ...
    with open('soccer-big5Leagues-Players-' + str(year) + '-' + followYear + '-Metadata.json','w') as f:
        f.write(meta)
    ...
    stats.to_csv('soccer-big5Leagues-Players-' + str(year) + '-' + followYear + '.csv',index=False)
